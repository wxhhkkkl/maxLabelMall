<template>
  ...
  <!-- 添加或修改请假申请弹窗 -->
  <OaLeaveApplyForm ref="formRef" @success="getList" />
  <!-- 请假申请详情弹窗 -->
  <OaLeaveApplyDetail ref="detailRef" />
</template>
...
const list = ref<LeaveApplyApi.LeaveApplyVO[]>([]) // 列表的数据
...
async function handleSubmit(id: number) {
  try {
    ...
    // 发起审批
    await LeaveApplyApi.submitLeaveApply(id, {})

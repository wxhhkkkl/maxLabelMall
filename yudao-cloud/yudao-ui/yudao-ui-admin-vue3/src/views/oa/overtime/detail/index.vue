  ...
  <div v-loading="detailLoading">
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="加班类型">
        <DictTag :type="DICT_TYPE.OA_OVERTIME_TYPE" :value="detailData.type ?? ''" />
      </el-descriptions-item>
...
const detailData = ref<OvertimeApplyApi.OvertimeApplyVO>({}) // 详情数据
...
async function getInfo() {
  ...
  try {
    detailData.value = await OvertimeApplyApi.getOvertimeApply(Number(id))
  } finally {

<template>
  ...
  <!-- 添加或修改加班申请弹窗 -->
  <OaOvertimeApplyForm ref="formRef" @success="getList" />
  <!-- 加班申请详情弹窗 -->
  <OaOvertimeApplyDetail ref="detailRef" />
</template>
...
import OaOvertimeApplyForm from './OaOvertimeApplyForm.vue'
import OaOvertimeApplyDetail from './OaOvertimeApplyDetail.vue'
...
const list = ref<OvertimeApplyApi.OvertimeApplyVO[]>([]) // 列表的数据
...
async function getList() {
  loading.value = true
  try {
    const data = await OvertimeApplyApi.getOvertimeApplyPage(queryParams)
...
async function handleSubmit(id: number) {
  try {
    ...
    // 发起审批
    await OvertimeApplyApi.submitOvertimeApply(id, {})

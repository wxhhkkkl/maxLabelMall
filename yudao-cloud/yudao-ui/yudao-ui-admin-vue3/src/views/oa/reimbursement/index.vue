<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-hasPermi="['oa:reimbursement:create']"
          type="primary"
          plain
  ...
  <!-- 添加或修改费用报销弹窗 -->
  <OaReimbursementForm ref="formRef" @success="getList" />
  <!-- 费用报销详情弹窗 -->
  <OaReimbursementDetail ref="detailRef" />
</template>
...
import OaReimbursementForm from './OaReimbursementForm.vue'
import OaReimbursementDetail from './OaReimbursementDetail.vue'

defineOptions({ name: 'OaReimbursement' })

const router = useRouter() // 路由
const message = useMessage() // 消息弹窗

const loading = ref(false) // 列表的加载中
const list = ref<ReimbursementApi.ReimbursementVO[]>([]) // 列表的数据

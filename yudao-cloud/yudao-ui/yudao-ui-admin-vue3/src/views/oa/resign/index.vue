<template>
  ...
  <!-- 添加或修改离职申请弹窗 -->
  <OaResignApplyForm ref="formRef" @success="getList" />
  <!-- 离职申请详情弹窗 -->
  <OaResignApplyDetail ref="detailRef" />
</template>
...
import OaResignApplyForm from './OaResignApplyForm.vue'
import OaResignApplyDetail from './OaResignApplyDetail.vue'
...
const list = ref<ResignApplyApi.ResignApplyVO[]>([]) // 列表的数据
...
async function getList() {
  loading.value = true
  try {
    const data = await ResignApplyApi.getResignApplyPage(queryParams)
...
async function handleSubmit(id: number) {
  try {
    ...
    // 发起审批
    await ResignApplyApi.submitResignApply(id, {})
